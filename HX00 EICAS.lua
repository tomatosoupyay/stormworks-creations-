...
function onTick()
    ...
    if throt > 0.9 and RA < 2.5 and flappos < 1.6 or throt > 0.9 and RA < 2.5 and pbrake then table.insert(wmsgs,"TOFF CONF") end
    ...
    if pbrake then table.insert(cmsgs,"PBRAKE") end
